...
public final class FireReceiver extends BroadcastReceiver {
     ...
     * @param intent  the incoming {@link dev.ukanth.ufirewall.locale.Intent#ACTION_FIRE_SETTING} Intent. This
     *                should contain the {@link dev.ukanth.ufirewall.locale.Intent#EXTRA_BUNDLE} that was saved by
    ...
    public void onReceive(final Context context, final Intent intent) {
         ...
         */
        if (!dev.ukanth.ufirewall.locale.Intent.ACTION_FIRE_SETTING.equals(intent.getAction())) {
            return;
        }
        ...
        BundleScrubber.scrub(intent.getBundleExtra(dev.ukanth.ufirewall.locale.Intent.EXTRA_BUNDLE));
        final Bundle bundle = intent.getBundleExtra(dev.ukanth.ufirewall.locale.Intent.EXTRA_BUNDLE);

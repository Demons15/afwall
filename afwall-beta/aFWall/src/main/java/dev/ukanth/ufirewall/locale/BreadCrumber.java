...
package dev.ukanth.ufirewall.locale;
...
public final class BreadCrumber
{
     ...
     * {@link dev.ukanth.ufirewall.locale.platform.R.string#twofortyfouram_locale_breadcrumb_format} string
                                                  ...
                                                  final String currentCrumb)
    {
        ...
        try
        {
             ...
             */
            final String breadcrumbString = intent.getStringExtra(dev.ukanth.ufirewall.locale.Intent.EXTRA_STRING_BREADCRUMB);
